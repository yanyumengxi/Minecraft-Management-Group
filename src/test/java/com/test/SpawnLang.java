...
public class SpawnLang {
    ...
    private static Logger logger = LoggerFactory.getLogger(SpawnLang.class);

    private static final String YOUDAO_URL = "https://openapi.youdao.com/api";

    private static final String APP_KEY = "4f49e6b624e57087";

    private static final String APP_SECRET = "v7MBMgSkBWAIzYG48I2wTF9YtnUVNeUJ";
